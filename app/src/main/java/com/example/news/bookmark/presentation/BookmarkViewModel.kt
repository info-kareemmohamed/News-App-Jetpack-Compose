...
import com.example.news.bookmark.domain.usecase.GetBookMarkedArticlesForBookmarkUseCase
...
class BookmarkViewModel @Inject constructor(
    private val getArticlesUseCase: GetBookMarkedArticlesForBookmarkUseCase,
): ViewModel() {
